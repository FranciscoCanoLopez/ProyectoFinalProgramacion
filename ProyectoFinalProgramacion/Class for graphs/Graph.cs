...
namespace ProyectoFinalProgramacion.Class_for_graphs
{
    internal class Graph
    {
        ...
        public string DFS(NodeGraph startNode)
        {
            ...
            List<NodeGraph> visited = new List<NodeGraph>();  // Lista de nodos visitados
        ...
        public string BFS(NodeGraph startNode)
        {
            ...
            List<NodeGraph> visited = new List<NodeGraph>();  // Lista de nodos visitados
            Queue<NodeGraph> queue = new Queue<NodeGraph>();  // Cola para el recorrido
            StringBuilder result = new StringBuilder();  // Para acumular el resultado
            ...
            while (queue.Count > 0)
            {
                NodeGraph currentNode = queue.Dequeue();  // Obtener el nodo al frente de la cola
