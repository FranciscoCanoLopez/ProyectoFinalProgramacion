using ProyectoFinalProgramacion.Class_for_graphs;
using System;
...
namespace ProyectoFinalProgramacion
{
    public partial class Graphs : Form
    {
        ...
        private void btnAddNode_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(nodeName))
            {
                ...
                else
                {
                    ...
                    NodeGraph newNode = new NodeGraph(nodeName);
        ...
        private void btnAddEdge_Click(object sender, EventArgs e)
        {
            ...
            NodeGraph fromNode = graph.Nodes.Find(n => n.Name == fromNodeName)!;
            NodeGraph toNode = graph.Nodes.Find(n => n.Name == toNodeName)!;
        ...
        {
            string nodeName = txtNode.Text.Trim();
            NodeGraph nodeToRemove = graph.Nodes.Find(n => n.Name == nodeName)!;
        ...
        private void btnShowDFS_Click(object sender, EventArgs e)
        {
            ...
            NodeGraph startNode = graph.Nodes.FirstOrDefault(n => n.Name == startNodeName)!;
